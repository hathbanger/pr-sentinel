...
import type { FinalDecision, FixResult, FixMode, TriageResult } from "./types";
...
export declare function reportIssueTriage(octokit: Octokit, issueNumber: number, result: TriageResult): Promise<void>;
